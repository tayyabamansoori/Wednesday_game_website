...
const appCss = "/assets/styles-DR2FM2JU.css";
...
const $$splitComponentImporter$8 = () => import("./game-Ba9s4kzM.js");
const Route$8 = createFileRoute("/game")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./contact-BWnqr-yb.js");
const Route$7 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Reach the residents of Nevermore through the ouija board. Mortal name, raven mail, and a dark message required."
    }, {
      property: "og:title",
      content: "Summon Us — Nevermore Academy"
    }, {
...
const $$splitComponentImporter$6 = () => import("./about-DiXNZqPO.js");
const Route$6 = createFileRoute("/about")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Behind the iron gates of Nevermore Academy: our story, our residents, and the events whispered in its halls."
    }, {
      property: "og:title",
      content: "About — Nevermore Academy of Outcasts"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$5 = () => import("./index-BUcvaO8b.js");
const Route$5 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A gothic interactive descent into Wednesday Addams' world."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./game.index-DP8QgO5P.js");
const Route$4 = createFileRoute("/game/")({
  head: () => ({
    meta: [{
      title: "Games — Nevermore Academy"
    }, {
      name: "description",
      content: "Choose your fate. Four gothic games await."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./game.web-B2g6BsPC.js");
const Route$3 = createFileRoute("/game/web")({
  head: () => ({
    meta: [{
      title: "The Web — Nevermore"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./game.visions-BBo-NRnf.js");
const Route$2 = createFileRoute("/game/visions")({
  head: () => ({
    meta: [{
      title: "Wednesday: Visions of Nevermore"
    }, {
      name: "description",
      content: "A gothic stealth puzzle inside Nevermore Academy."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./game.oracle-B56ziXOJ.js");
const Route$1 = createFileRoute("/game/oracle")({
  head: () => ({
    meta: [{
      title: "Oracle — Nevermore"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./game.hunt-4guVJFSF.js");
const Route2 = createFileRoute("/game/hunt")({
  head: () => ({
    meta: [{
      title: "The Hunt — Nevermore"
    }]
  }),
...
const GameIndexRoute = Route$4.update({
  id: "/",
  path: "/",
  getParentRoute: () => GameRoute
});
const GameWebRoute = Route$3.update({
  id: "/web",
  path: "/web",
  getParentRoute: () => GameRoute
});
const GameVisionsRoute = Route$2.update({
  id: "/visions",
  path: "/visions",
  getParentRoute: () => GameRoute
});
const GameOracleRoute = Route$1.update({
  id: "/oracle",
  path: "/oracle",
  getParentRoute: () => GameRoute
});
const GameHuntRoute = Route2.update({
  id: "/hunt",
  path: "/hunt",
  getParentRoute: () => GameRoute
});
const GameRouteChildren = {
  GameHuntRoute,
  GameOracleRoute,
  GameVisionsRoute,
  GameWebRoute,
